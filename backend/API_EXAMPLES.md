...
8. [Saved Listing Endpoints](#saved-listing-endpoints)
9. [Report Endpoints](#report-endpoints)
10. [Conversation (Messaging) Endpoints](#conversation-messaging-endpoints)
11. [Guest Contact Endpoints](#guest-contact-endpoints)
12. [Admin Endpoints](#admin-endpoints)
13. [UploadThing File Upload](#uploadthing-file-upload)
...
### 18. Get Seller Information (Public)

Get detailed information about a seller including their profile and statistics.
...
### 19. Get Seller Listings (Public)

Get all listings from a specific seller with comprehensive search, filter, and pagination support.

**Request:**
```http
GET /api/v1/sellers/:userId/listings?q=iphone&categoryId=2&minPrice=1000&maxPrice=50000&status=active&sort=newest&page=1&limit=20
```
...
- `status` (optional): Filter by status (active, sold, expired, pending - default: active)
- `sort` (optional): Sort order (newest, oldest, price_asc, price_desc - default: newest)
- `page` (optional): Page number (default: 1)
- `limit` (optional): Items per page (default: 20, max: 100)

**cURL:**
```bash
curl "http://localhost:3000/api/v1/sellers/3/listings?q=iphone&categoryId=2&minPrice=1000&status=active&sort=newest&page=1&limit=20"
```
...
### 20. Get Seller Reviews (Public)

Get all reviews for a specific seller with pagination.

**Request:**
```http
GET /api/v1/sellers/:userId/reviews?limit=50&offset=0
```

**Query Parameters:**
- `limit` (optional): Number of reviews per page (default: 50, max: 100)
- `offset` (optional): Number of reviews to skip (default: 0)

**cURL:**
```bash
curl "http://localhost:3000/api/v1/sellers/3/reviews?limit=50&offset=0"
```
  ...
  "data": [
    {
      ...
      "reviewer_first_name": "ผู้ซื้อ",
      "reviewer_last_name": "คนที่หนึ่ง",
...
### 22. Get Category by Slug (Public)
...
### 23. Get Listings by Category (Public)
...
### 29. Create Review (Authenticated)
...
### 30. Check If User Reviewed Listing (Authenticated)
...
### 31. Delete Review (Authenticated)
...
### 32. Mark Review as Spam (Admin Only)
...
### 34. Unsave Listing (Authenticated)
...
### 35. Get Saved Listings (Authenticated)
...
### 36. Check If Listing is Saved (Authenticated)
...
### 38. Submit Report (Public/Authenticated)
...
### 40. Get Report Details (Admin Only)
...
### 41. Get Report Statistics (Admin Only)
...
### 42. Update Report Status (Admin Only)
...
### 43. Create or Get Conversation (Authenticated)
...
### 44. Get User Conversations (Authenticated)
...
### 45. Get Unread Message Count (Authenticated)
...
### 46. Get Conversation Messages (Authenticated)
...
### 48. Mark Messages as Read (Authenticated)
...
### 49. Delete Conversation (Authenticated)
...
### 50. Submit Guest Contact (Public)
...
### 51. Get Listing Guest Contacts (Seller Only)
...
### 52. Get All Seller's Guest Contacts (Seller Only)
...
### 53. Create Admin Account (Super Admin Only)
...
### 54. Delete User Account (Super Admin Only)
...
**API Version:** 5.1 (Complete with Seller Endpoints)
...
- Get seller information (username, avatar, ratings, listing count)
- Get seller listings with filters and pagination
